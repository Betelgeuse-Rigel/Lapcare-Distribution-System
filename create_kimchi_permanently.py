...
category_name = "Kimchi Category Permanent"
product_name = "Kimchi Ramen Permanent"
sku_code = f"KIMCHI-{int(time.time()) % 10000}"
...
with sync_playwright() as p:
    ...
    print("Permanent Product Created successfully!")
    browser.close()

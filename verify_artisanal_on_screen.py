...
category_name = "Artisanal Category"
product_name = "Artisanal Ramen"
sku_code = f"RAMEN-{int(time.time()) % 10000}"
...
with sync_playwright() as p:
    ...
    page.set_input_files('input[type="file"]', '/Users/nikola/.gemini/antigravity-ide/brain/a519c41d-be42-49d3-b829-a45d40d5c7fe/media__1783583230226.jpg')
    ...
    page.locator('.form-group:has-text("Brand") input').fill('korean')
    ...
    page.locator('.form-group:has-text("Product Image") input[type="file"]').set_input_files('/Users/nikola/.gemini/antigravity-ide/brain/a519c41d-be42-49d3-b829-a45d40d5c7fe/media__1783583230226.jpg')
    ...
    print("Test completed. Closing browser, product remains in system.")
    browser.close()
